...
namespace NXP_Stocker_BlazorProject.TaskPackage.ThreadTaskPackage
{
    ...
    public partial class ThreadTaskPack<EPLC> : IThreadTaskPack
    {
        ...
        public async Task<bool> GetPlcWarehouse()
        {
            ...
            {
                if(plcLib.Packages[Robot].property.getRobot.dcWarehouse.Count == 458)
                {
                    IDataService.DcWarehouse = _upWarehouse(plcLib.Packages[Robot].property.getRobot.dcWarehouse);
                }
        ...
        {
            await IMainObser.NotifyWarehouseInform(IDataService.DcWarehouse);
        }
    }
}
